...
describe('#get()', function () {
  ...
  it('should get data', function () {
    return io.get('/hero', success, fail).then(function (data) {
  ...
  it('should get data with query', function () {
    return io.get('/hero/pick', {
      pos: 'support',
      attr: 'int'
  ...
  it('should trigger fail if server throw a string error', function () {
    return io.get('/server/error', success, fail)
      .then(fulfilled, function (err) {
  ...
  it('should trigger fail if server throw a standard error', function () {
    return io.get('/server/error/standard', success, fail)
      .then(fulfilled, function (err) {
