...
describe('#put()', function () {
  ...
  it('should put data', function (done) {
    io.put('/hero', success, fail).then(function (data) {
  ...
  it('should put data with query', function (done) {
    io.put('/hero/pick', {
      pos: 'support',
      attr: 'int'
  ...
  it('should trigger fail if server throw a string error', function (done) {
    io.put('/server/error', success, fail)
      .catch(function (err) {
  ...
  it('should trigger fail if server throw a standard error', function (done) {
    io.put('/server/error/standard', success, fail)
      .catch(function (err) {
