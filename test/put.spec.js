...
describe('#put()', function () {
  ...
  it('should put data', function () {
    return io.put('/hero', success, fail).then(function (data) {
  ...
  it('should put data with query', function () {
    return io.put('/hero/pick', {
      pos: 'support',
      attr: 'int'
  ...
  it('should trigger fail if server throw a string error', function () {
    return io.put('/server/error', success, fail)
      .then(fulfilled, function (err) {
  ...
  it('should trigger fail if server throw a standard error', function () {
    return io.put('/server/error/standard', success, fail)
      .then(fulfilled, function (err) {
