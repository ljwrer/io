...
describe('#json post()', function () {
  ...
  it('should post data', function (done) {
    io.post('/hero', success, fail).then(function (data) {
  ...
  it('should post data with query', function (done) {
    io.post('/hero/pick', {
      pos: 'support',
      attr: 'int'
  ...
  it('should trigger fail if server throw a string error', function (done) {
    io.post('/server/error', success, fail)
      .catch(function (err) {
  ...
  it('should trigger fail if server throw a standard error', function (done) {
    io.post('/server/error/standard', success, fail)
      .catch(function (err) {
